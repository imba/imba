...
let bundles = [
	...
	},
	{
		...
		format: "cjs",
		outdir: "dist",
		external: ["lodash.merge", "vite", 'picocolors', 'local-pkg'],
		platform: "node",
	},
	{
		entryPoints: ["src/imba/imba.imba"],
		...
		format: "esm",
		outdir: "dist",
		external: [ "vite", 'picocolors', 'local-pkg', 'get-port'],
		platform: "node",
	},
	{
		entryPoints: [
		...
		minify: true,
		external: ["lodash.merge", "chokidar", "esbuild", "vite-node/client","vite-node/server", "vite"],
		outdir: ".",
		format: "cjs",
		platform: "node",
	},
	...
	},
	{
		...
		outExtension: { ".js": ".mjs" },
		minify: true,
		external: ["lodash.merge", "picocolors", "vite", "imba", "debug", "deepmerge", "diff", "magic-string", "picomatch", "get-port", "esbuild"],
		outdir: "dist",
		format: "esm",
		platform: "node",
	},
