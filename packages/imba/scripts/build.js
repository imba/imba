...
let bundles = [
	...
	},
	{
		...
		format: "cjs",
		outdir: "dist",
		external: ["vite", 'picocolors', 'local-pkg'],
		platform: "node",
	},
	{
		entryPoints: ["src/imba/imba.imba"],
	...
	},
	{
		...
		outExtension: { ".js": ".mjs" },
		minify: true,
		external: ["vite", "imba", "debug", "deepmerge", "diff", "kleur", "magic-string", "picomatch", "get-port", "esbuild"],
		outdir: "dist",
		format: "esm",
		platform: "node",
	},
	{
		...
		outExtension: { ".js": ".cjs" },
		minify: true,
		external: ["vite", "imba", "debug", "deepmerge", "diff", "kleur", "magic-string", "picomatch", "esbuild"],
		outdir: "dist",
		format: "cjs",
		platform: "node",
	},
