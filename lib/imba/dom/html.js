...
Imba.createTagScope(/*SCOPEID*/).extendTag('html', null, function(tag){
	tag.prototype.parent = function (){
		return null;
	};
});

Imba.createTagScope(/*SCOPEID*/).extendTag('canvas', null, function(tag){
...
Imba.createTagScope(/*SCOPEID*/).extendTag('input', null, function(tag){
...
Imba.createTagScope(/*SCOPEID*/).extendTag('textarea', null, function(tag){
	Object.defineProperty(tag.prototype,'lazy',{
		configurable: true,
		get: function(){ return this._lazy; },
		set: function(v){ this._lazy = v; }
...
Imba.createTagScope(/*SCOPEID*/).extendTag('option', null, function(tag){
...
Imba.createTagScope(/*SCOPEID*/).extendTag('select', null, function(tag){
	tag.prototype.bindData = function (target,path,args){
		DataProxy.bind(this,target,path,args);
		return this;
	};
