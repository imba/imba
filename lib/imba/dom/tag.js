...
Imba.Tag.inherit = function (child){
	...
	if (this._nodeType) {
		...
		child._classes = this._classes.slice(0);
...
Object.defineProperty(Imba.Tag.prototype,'data',{set: function(value){
	return this._data = value;
}, configurable: true});

Object.defineProperty(Imba.Tag.prototype,'data',{get: function(){
	return this._data;
}, configurable: true});
