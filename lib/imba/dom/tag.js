...
Imba.Tag.prototype.setFlag = function (name,value){
	var $_;
	var flags = ($_ = this.$).flags || ($_.flags = {});
	var prev = flags[name];
	if (prev != value) {
...
TagCache.prototype.$$ = function (name){
	return this[name] || (this[name] = new TagCache(this[0]));
};

// returns a new fast list
TagCache.prototype.a$ = function (type,slot,par){
	var item = [];
	item.static = type;
	item._tag = this._tag;
	this[slot] = item;
...
// returns a new 
TagCache.prototype.l$ = function (slot){
	var item = [];
	item.static = 5;
	item.cache = this;
	return item;
...
TagCache.prototype.$ = function (type,key,par){
	var cache = this;
	var node;
