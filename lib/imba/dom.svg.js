(function(){
	...
	Imba.TAGS.SVG.defineTag('svg', function(tag){
		...
		tag.prototype.__viewbox = {name: 'viewbox'};
		...
		tag.prototype.__width = {name: 'width'};
		...
		tag.prototype.__height = {name: 'height'};
