(function(){
	...
	Imba.TAGS.defineTag('a', function(tag){
		...
		tag.prototype.__href = {name: 'href'};
	...
	Imba.TAGS.defineTag('button', function(tag){
		...
		tag.prototype.__type = {name: 'type'};
		...
		tag.prototype.__disabled = {name: 'disabled'};
	...
	Imba.TAGS.defineTag('form', function(tag){
		...
		tag.prototype.__method = {name: 'method'};
		...
		tag.prototype.__action = {name: 'action'};
	...
	Imba.TAGS.defineTag('input', function(tag){
		...
		tag.prototype.__required = {name: 'required'};
	...
	Imba.TAGS.defineTag('link', function(tag){
		...
		tag.prototype.__media = {name: 'media'};
	...
	Imba.TAGS.defineTag('meta', function(tag){
		...
		tag.prototype.__content = {name: 'content'};
		...
		tag.prototype.__charset = {name: 'charset'};
	...
	Imba.TAGS.defineTag('option', function(tag){
		...
		tag.prototype.__value = {name: 'value'};
	...
	Imba.TAGS.defineTag('select', function(tag){
		...
		tag.prototype.__multiple = {name: 'multiple'};
	...
	Imba.TAGS.defineTag('textarea', function(tag){
		...
		tag.prototype.__rows = {name: 'rows'};
		...
		tag.prototype.__cols = {name: 'cols'};
