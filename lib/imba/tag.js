(function(){
	...
	*/
	...
	Imba.Tags.prototype.__base = function (){
		
	};
	
	
	Imba.Tags.prototype.__clone = function (){
		var clone = Object.create(this);
		clone._parent = this;
		return clone;
	};
	
	Imba.Tags.prototype.__def = function (name,supr,body){
	...
	Imba.Tags.prototype.__extend = function (name,body){
	...
	Imba.defineSingletonTag = function (id,supr,body){
		...
		return Imba.TAGS.__def(this.name(),supr,body);
	};
