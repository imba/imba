(function(){
	...
	Block.prototype.consume = function (node){
		...
		if (node instanceof TagTree) { // special case?!?
			...
			if (!node._loop && this._nodes.length > 1) {
				this._nodes.unshift(new Num(node.blocks().push(this)));
	...
	Root.prototype.compile = function (o){
		...
		this.traverse();
		var out = this.c();
		var result = {js: out,warnings: this.scope().warnings(),options: o,toString: function() {
			return this.js;
		}};
		return result;
	};
