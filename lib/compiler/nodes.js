...
Tag.prototype.childRef = function (){
	return this._options.loop ? null : this.cacheRef();
};
...
Tag.prototype.js = function (jso){
	...
	if (o.body instanceof Func) {
		...
		if ((o.body instanceof ArgList) && o.body.count() == 1) {
			var body1 = o.body.first();
			if (body1.isString()) {
				content = body1;
				...
				console.log("TAGLOOP IS BODY(!)",body1.option('treeType'));
