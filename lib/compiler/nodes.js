...
Block.prototype.visit = function (stack){
	...
	if (stack && stack._tag) {
		...
		if (real.length > 1) {
			...
			this._indentation = null;
			if (true || this._tag.reactive()) {
				this._nodes = [Util.callImba(this.scope__(),"static",[arr,nr,new Num(typ)])];
			} else {
				this._nodes = [arr];
			};
		};
...
Tag.prototype.visit = function (stack){
	...
	if (typ == '->' || typ == '=>') {
		...
		this._fragment = o.body = new TagFragmentFunc([],body,null,null,{closed: close});
...
Tag.prototype.cacher = function (){
	...
	return (this._options.cacher == null) ? (this._options.cacher = this.parent() ? (
		...
		new TagCache(this,this._tagScope.declare("$",op))
	) : (
		null
...
Tag.prototype.childCacher = function (){
	return this._options.childCacher || (this._options.childCacher = (this._fragment || this.isSelf()) ? (
		...
		new TagCache(this,this._tagScope.declare("$",OP('.',new This(),'$')))
...
Tag.prototype.cacheRef = function (){
	...
	return o.treeRef = (o.ivar ? new Str("'" + o.ivar.c() + "'") : this.cacher().nextRef());
};
...
Tag.prototype.js = function (jso){
	...
	if (this.isSelf()) {
		...
		if (cacher) {
			...
			if (parent && parent.cacher() == cacher) {
	...
	if (o.body instanceof Func) {
		...
		if (len$(children) == 1) {
			...
			contentType = children.every(function(item) { return (item instanceof Tag) || item.option('treeType') == 2; }) ? 2 : 1;
	...
	calls.push(("." + (this.isSelf() ? "synced" : "end") + "()"));
