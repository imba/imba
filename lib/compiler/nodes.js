...
TagHandler.prototype.isStatic = function (){
	return (!(this.value()) || this.value().isPrimitive()) && this._chain.every(function(item) {
...
TagHandler.prototype.js = function (o){
	return ("on$(" + this.quoted() + ",[" + cary__(this._chain) + "]," + this.slot() + ")");
};
...
Tag.prototype.isSelf = function (){
	return this.type() instanceof Self;
};
