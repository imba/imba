(function(){
	...
	TagDeclaration.prototype.tagspace = function (){
		return this.name().ns() ? (("Imba.TAGS." + (this.name().ns().toUpperCase()))) : ("Imba.TAGS");
	};
	...
	TagDeclaration.prototype.js = function (o){
		...
		if (this.option('extension')) {
			return ("" + mark + this.tagspace() + ".extendTag('" + (this.name().id() || this.name().func()) + "'" + outbody + ")");
		};
		
		var sup = this.superclass() && "," + helpers.singlequote(this.superclass().func()) || "";
		
		var out = this.name().id() ? (
			("" + mark + this.tagspace() + ".defineSingleton('" + (this.name().id()) + "'" + sup + outbody + ")")
		) : (
			("" + mark + this.tagspace() + ".defineTag('" + (this.name().name()) + "'" + sup + outbody + ")")
		);
