...
Root.prototype.analyze = function (o){
	...
	var out = this.scope().dump();
	out.tokens = o._tokens;
	return out;
};
...
PropertyAccess.prototype.visit = function (){
	...
	if (!((this.up() instanceof Call))) {
		this.scope__().root()._implicitCalls.push(this._right);
	};
	return this;
};
...
VarOrAccess.prototype.visit = function (){
	...
	if (!((this.up() instanceof Call))) { scope.root()._implicitCalls.push(this.value()) };
...
Scope.prototype.imba = function (){
	return this.root().requires('imba1','Imba');
};
...
RootScope.prototype.dump = function (){
	var obj = {
		...
		autocall: this._implicitCalls.map(function(s) { return s.dump(); })
	};
