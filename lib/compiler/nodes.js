...
Stack.prototype.v2 = function (){
	return !(!this.option('v2'));
};

Stack.prototype.v1 = function (){
	return !(this.v2());
};
...
PropertyDeclaration.prototype.c = function (){
	...
	if (isNative == true || (STACK.v2() && isNative !== false)) {
...
PropertyAccess.prototype.js = function (o){
	...
	if (!(up instanceof Call) && STACK.v1()) {
...
Assign.prototype.js = function (o){
	...
	if ((l instanceof PropertyAccess) && STACK.v1()) {
...
TagData.prototype.js = function (){
	...
	if (val instanceof Access) {
		...
		if ((val instanceof PropertyAccess) && STACK.v1()) {
			pars.push('[]');
		};
