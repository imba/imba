(function(){
	...
	(function(){
		...
		tag.prototype.template = function (){
			// <div.head>
			return [t$('ast_param_list').setObject(this.object().params()).end(),
			this.object().body().dom()
			];
		};
	...
	(function(){
		...
		tag.prototype.template = function (){
			return [t$('ast').flag("keyword").setContent(["return"]).end(),
			t$('div').setContent(["&nbsp;"]).end(),
	...
	(function(){
		...
		tag.prototype.template = function (){
			// what about the receiver?
			return [t$('ast').flag("left").setContent([this.object().left()]).end(),
	...
	(function(){
		...
		tag.prototype.template = function (){
			return [t$('ast').flag("keyword").flag("var").flag("rs").setContent(["var"]).end(),
			this.object().value()
			];
		};
