(function(){
	...
	cli.command('compile <path>').description('compile scripts').option('-m, --source-map-inline','Embed inline sourcemap in compiled JavaScript').option('-s, --standalone','Embed utils from Imba runtime').option('-t, --target [platform]','Compile for specific platform').option('-b, --bare','Skipp wrapping code in outer closure').option('-o, --output [dest]','set the output directory for compiled JavaScript').action(function(path,o) { return cliCompile(path,o,{watch: false}); });
	
	cli.command('watch <path>').description('listen for changes and compile scripts').option('-m, --source-map-inline','Embed inline sourcemap in compiled JavaScript').option('-s, --standalone','Embed utils from Imba runtime').option('-t, --target [platform]','Compile for specific platform').option('-b, --bare','Skipp wrapping code in outer closure').option('-o, --output [dest]','set the output directory for compiled JavaScript').action(function(root,o) { return cliCompile(root,o,{watch: true}); });
