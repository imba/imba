...
var grammar = {
	...
	Decorator: [
		o('DECORATOR',function() { return new Decorator(A1); }) // kinda hacky, should be defined as something else
	],
	...
	TagOptions: [
		...
		o('TagOptions ( )',function() { return A1.addPart(null,AST.TagArgList); }),
	...
	TagId: [
		o('TAGID',function() { return new TagIdRef(A1); })
	],
	...
	Method: [
		...
		o('VarKeyword MethodDeclaration',function() { return A2.set({variable: A1}); }),
	...
	Operation: [
		...
		o('Expression EXP      Expression',function() { return AST.OP(A2,A1,A3); }),
