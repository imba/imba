...
We cannot know upfront whether a simple identifier should be an implicit call
or not. The best thing is probably to just do accessors and invocations separately
and then 
...
})],VarReference: [o('VAR SPLAT Identifier',function (){
	return SPLAT(new VarReference(A3,A1),A2);
}), o('VAR Identifier',function (){
	return new VarReference(A2,A1);
}), o('LET Identifier',function (){
	return new VarReference(A2,A1);
}), o('LET SPLAT Identifier',function (){
	return SPLAT(new VarReference(A3,A1),A2);
})],SimpleAssignable: [o('Const',function (){
	return A1;
}), o('Ivar',function (){
