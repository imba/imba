...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,i,r){if(i instanceof Array)for(var o=0,s=t(i),f=s.length;f>o;o++)e(n,s[o],r);else if("number"==typeof i||i instanceof Number);else if("string"==typeof i){var h=r?r.nextSibling:n._dom.firstChild;if(!(h instanceof Text))throw"cannot remove string";n.removeChild(h)}else i&&n.removeChild(i);return r}function n(e,i){if(i instanceof Array)for(var r=0,o=t(i),s=o.length;s>r;r++)n(e,o[r]);else"number"==typeof i||i instanceof Number||("string"==typeof i||i instanceof String?e.appendChild(Imba.document().createTextNode(i)):i&&e.appendChild(i))}function i(e,n,r){if(("string"==typeof n||n instanceof String)&&(n=Imba.document().createTextNode(n)),n instanceof Array)for(var o=0,s=t(n),f=s.length;f>o;o++)i(e,s[o],r);else"number"==typeof n||n instanceof Number||n&&e.insertBefore(n,r);return r}function r(t,e,r){var o=r?r.nextSibling:t._dom.firstChild;return o?(i(t,e,o),o.previousSibling):(n(t,e),t._dom.lastChild)}function o(e,n,i,o){for(var s,f=n.length,h=(i.length,n[f-1]),l=[],a=[],c=[],u=0,d=0,g=0,m=t(i),p=m.length;p>g;g++){s=m[g];var y=n.indexOf(s);if(l.push(y),-1!=y){for(var v=l.length-2;v>=0;)if(-1==l[v])v--;else{if(y>l[v])break;v=a[v]}a.push(v);var _=-1==v?0:c[v]+1;_>u&&(u=_,d=g),c.push(_)}else e.removeChild(s),a.push(-1),c.push(-1)}for(var x=[],b=l.length-1;b>=0;)-1==l[b]||b==d&&(x[l[b]]=!0,d=a[d]),b-=1;for(var C=0,m=t(n),p=m.length;p>C;C++)if(!x[C]){var S=n[C-1];r(e,m[C],S&&S._dom||o)}return h&&h._dom||o}function s(t,e,n,i){var r=e.length,s=r,f=e[r-1];if(r==n.length&&e[0]===n[0])for(;s--&&e[s]===n[s];);return-1==s?f&&f._dom||i:o(t,e,n,i)}function f(n,i,o,h,l,a){if(i===o)return null==i||i===!1||i===!0?h:i&&i._dom?i._dom:h?h.nextSibling:n._dom.firstChild;if(i instanceof Array&&o instanceof Array){if(!i["static"])return s(n,i,o,h);if(i["static"]==o["static"]){for(var c=0,u=t(i),d=u.length;d>c;c++)h=f(n,u[c],o[c],h,i,c);return h}}else if("string"==typeof i||i instanceof String){var g;if("string"==typeof o){var m=h?h.nextSibling:n._dom.firstChild;m instanceof Text&&(o=m)}return o instanceof Text?(o.textContent!=i&&(o.textContent=i),g=o):(o&&e(n,o,h),g=Imba.document().createTextNode(i),r(n,g,h)),h=g}return o&&e(n,o,h),i&&(h=r(n,i,h)),h}return Imba.extendTag("htmlelement",function(e){e.prototype.setChildren=function(t,e){if(t===this._children)return this;if("string"==typeof t)return this.setText(t),t;if(1==e)return this.setStaticChildren(t);if(2==e)return this._children||n(this,this._children=t),this;if(3==e){this._children;f(this,t,this._children,null,null,0)}else t instanceof Array&&this._children instanceof Array?s(this,t,this._children,null):this.empty().append(t);return this._children=t,this},e.prototype.setStaticChildren=function(e){var i,r,o=this._children;if(1==e.length&&("string"==typeof e[i=0]||e[i]instanceof String))return this.setText(e[r=0]),e[r];if(o)if(e["static"])f(this,e,o,null,null,0);else for(var s=null,h=0,l=t(e),a=l.length;a>h;h++)s=f(this,l[h],o[h],s,e,h);else this.empty(),n(this,e);return this._children=e,this},e.prototype.content=function(){return this._content||this.children().toArray()},e.prototype.setText=function(t){return t!=this._children&&(this.dom().textContent=this._children=t),this}})}();
},{}],9:[function(require,module,exports){
!function(){"undefined"!=typeof window&&(global=window),Imba={VERSION:"0.13.3"};var n=/-./g;return Imba.toCamelCase=function(e){return e.replace(n,function(n){return n.charAt(1).toUpperCase()})}}();
