...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,i,r){if(i instanceof Array)for(var o=0,s=t(i),f=s.length;f>o;o++)e(n,s[o],r);else if("number"==typeof i||i instanceof Number);else if("string"==typeof i){var h=r?r.nextSibling:n._dom.firstChild;if(!(h instanceof Text))throw"cannot remove string";n.removeChild(h)}else i&&n.removeChild(i);return r}function n(e,i){if(i instanceof Array)for(var r=0,o=t(i),s=o.length;s>r;r++)n(e,o[r]);else"number"==typeof i||i instanceof Number||("string"==typeof i||i instanceof String?e.appendChild(Imba.document().createTextNode(i)):i&&e.appendChild(i))}function i(e,n,r){if(("string"==typeof n||n instanceof String)&&(n=Imba.document().createTextNode(n)),n instanceof Array)for(var o=0,s=t(n),f=s.length;f>o;o++)i(e,s[o],r);else"number"==typeof n||n instanceof Number||n&&e.insertBefore(n,r);return r}function r(t,e,r){var o=r?r.nextSibling:t._dom.firstChild;return o?(i(t,e,o),o.previousSibling):(n(t,e),t._dom.lastChild)}function o(e,n,i,o){for(var s,f=n.length,h=(i.length,n[f-1]),a=[],l=[],c=[],u=0,d=0,p=0,m=t(i),g=m.length;g>p;p++){s=m[p];var y=n.indexOf(s);if(a.push(y),-1!=y){for(var v=a.length-2;v>=0;)if(-1==a[v])v--;else{if(y>a[v])break;v=l[v]}l.push(v);var _=-1==v?0:c[v]+1;_>u&&(u=_,d=p),c.push(_)}else e.removeChild(s),l.push(-1),c.push(-1)}for(var x=[],b=a.length-1;b>=0;)-1==a[b]||b==d&&(x[a[b]]=!0,d=l[d]),b-=1;for(var C=0,m=t(n),g=m.length;g>C;C++)if(!x[C]){var S=n[C-1];r(e,m[C],S&&S._dom||o)}return h&&h._dom||o}function s(t,e,n,i){var r=e.length,s=r,f=e[r-1];if(r==n.length&&e[0]===n[0])for(;s--&&e[s]===n[s];);return-1==s?f&&f._dom||i:o(t,e,n,i)}function f(n,i,o,h,a,l){if(i===o)return null==i||i===!1||i===!0?h:i&&i._dom?i._dom:h?h.nextSibling:n._dom.firstChild;if(i instanceof Array&&o instanceof Array){if(!i["static"])return s(n,i,o,h);if(i["static"]==o["static"]){for(var c=0,u=t(i),d=u.length;d>c;c++)h=f(n,u[c],o[c],h,i,c);return h}}else if("string"==typeof i||i instanceof String){var p;if("string"==typeof o){var m=h?h.nextSibling:n._dom.firstChild;m instanceof Text&&(o=m)}return o instanceof Text?(o.textContent!=i&&(o.textContent=i),p=o):(o&&e(n,o,h),p=Imba.document().createTextNode(i),r(n,p,h)),h=p}return o&&e(n,o,h),i&&(h=r(n,i,h)),h}return Imba.extendTag("htmlelement",function(t){t.prototype.setChildren=function(t){return t===this._children?this:t&&t["static"]?this.setStaticChildren(t):(t instanceof Array&&this._children instanceof Array?s(this,t,this._children,null):"string"==typeof t||t instanceof String?this.setText(t):this.empty().append(t),this._children=t,this)},t.prototype.setStatics=function(t){return this._children||(this.empty(),n(this,t),this._children=t),this},t.prototype.setStaticChildren=function(t){var e,i,r=this._children,o=null;return 1==t.length&&("string"==typeof t[e=0]||t[e]instanceof String)?(this.setText(t[i=0]),t[i]):(r?f(this,t,r,o,null,0):(this.empty(),n(this,t)),this._children=t,this)},t.prototype.content=function(){return this._content||this.children().toArray()},t.prototype.setText=function(t){return t!=this._children&&(this.dom().textContent=this._children=t),this}})}();
