...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,i,r){if(i instanceof f)n.removeChild(i);else if(i instanceof Array)for(var o=0,s=t(i),l=s.length;l>o;o++)e(n,s[o],r);else{var h=r?r.nextSibling:n._dom.firstChild;if(!(h instanceof Text&&h.textContent==i))throw"cannot remove string";n.removeChild(h)}return r}function n(e,i){if(i instanceof f)e.appendChild(i);else if(i instanceof Array)for(var r=0,o=t(i),s=o.length;s>r;r++)n(e,o[r]);else null!=i&&i!==!1&&e.appendChild(Imba.document().createTextNode(i))}function i(e,n,r){if(n instanceof f)e.insertBefore(n,r);else if(n instanceof Array)for(var o=0,s=t(n),l=s.length;l>o;o++)i(e,s[o],r);else null!=n&&n!==!1&&e.insertBefore(Imba.document().createTextNode(n),r);return r}function r(t,e,r){var o=r?r.nextSibling:t._dom.firstChild;return o?(i(t,e,o),o.previousSibling):(n(t,e),t._dom.lastChild)}function o(e,n,i,o){for(var s,l=n.length,f=(i.length,n[l-1]),h=[],a=[],u=[],c=0,d=0,m=0,v=t(i),p=v.length;p>m;m++){s=v[m];var g=n.indexOf(s);if(h.push(g),-1!=g){for(var C=h.length-2;C>=0;)if(-1==h[C])C--;else{if(g>h[C])break;C=a[C]}a.push(C);var y=-1==C?0:u[C]+1;y>c&&(c=y,d=m),u.push(y)}else e.removeChild(s),a.push(-1),u.push(-1)}for(var _=[],x=h.length-1;x>=0;)-1==h[x]||x==d&&(_[h[x]]=!0,d=a[d]),x-=1;for(var A=0,v=t(n),p=v.length;p>A;A++)if(!_[A]){var b=n[A-1];r(e,v[A],b&&b._dom||o)}return f&&f._dom||o}function s(t,e,n,i){var r=e.length,s=r,l=e[r-1];if(r==n.length&&e[0]===n[0])for(;s--&&e[s]===n[s];);return-1==s?l&&l._dom||i:o(t,e,n,i)}function l(n,i,o,h){var a=null==i||i===!1,u=null==o||o===!1;if(i===o)return a?h:i&&i._dom?i._dom:h?h.nextSibling:n._dom.firstChild;if(i instanceof Array){if(o instanceof Array){if(!i["static"]&&!o["static"])return s(n,i,o,h);if(i["static"]==o["static"]){for(var c=0,d=t(i),m=d.length;m>c;c++)h=l(n,d[c],o[c],h);return h}e(n,o,h)}else o instanceof f?n.removeChild(o):u||n.removeChild(h?h.nextSibling:n._dom.firstChild);return r(n,i,h)}if(i instanceof f)return u||e(n,o,h),r(n,i,h),i;if(a)return u||e(n,o,h),h;var v;if(o instanceof Array)e(n,o,h);else if(o instanceof f)n.removeChild(o);else if(!u&&(v=h?h.nextSibling:n._dom.firstChild,v instanceof Text&&v.textContent!=i))return v.textContent=i,v;return r(n,i,h)}var f=Imba.TAGS.element;return Imba.extendTag("htmlelement",function(e){e.prototype.setChildren=function(e,i){var r=this._children;if(e===r)return this;if(r){if(2==i)return this;if(1==i)for(var o=null,h=0,a=t(e),u=a.length;u>h;h++)o=l(this,a[h],r[h],o);else if(3==i)if(e instanceof f)this.empty(),this.appendChild(this.nodes());else{if(!(e instanceof Array))return this.setText(e),this;r instanceof Array?s(this,e,r,null):(this.empty(),n(this,e))}else e instanceof Array&&r instanceof Array?s(this,e,r,null):(this.empty(),this.appendChild(e))}else this.empty(),n(this,e);return this._children=e,this},e.prototype.setStaticChildren=function(e){for(var n=this._children,i=null,r=0,o=t(e),s=o.length;s>r;r++)i=l(this,o[r],n[r],i);return this._children=e,this},e.prototype.content=function(){return this._content||this.children().toArray()},e.prototype.setText=function(t){return t!=this._children&&(this._children=t,this.dom().textContent=null==t||t===!1?"":t),this}})}();
},{}],9:[function(require,module,exports){
!function(){"undefined"!=typeof window&&(global=window),Imba={VERSION:"0.13.6"};var n=/-./g;return Imba.toCamelCase=function(e){return e.replace(n,function(n){return n.charAt(1).toUpperCase()})}}();
