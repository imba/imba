...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,r,i){if(r instanceof Array)for(var o=0,s=t(r),f=s.length;f>o;o++)e(n,s[o],i);else"number"==typeof r||r instanceof Number||r&&n.removeChild(r);return i}function n(e,r){if(r instanceof Array)for(var i=0,o=t(r),s=o.length;s>i;i++)n(e,o[i]);else"number"==typeof r||r instanceof Number||("string"==typeof r||r instanceof String?e.appendChild(Imba.document().createTextNode(r)):r&&e.appendChild(r))}function r(e,n,i){if(("string"==typeof n||n instanceof String)&&(n=Imba.document().createTextNode(n)),n instanceof Array)for(var o=0,s=t(n),f=s.length;f>o;o++)r(e,s[o],i);else"number"==typeof n||n instanceof Number||n&&e.insertBefore(n,i);return i}function i(t,e,i){var o=i?i.nextSibling:t._dom.firstChild;return o?(r(t,e,o),o.previousSibling):(n(t,e),t._dom.lastChild)}function o(e,n,r,o){for(var s,f=n.length,a=(r.length,n[f-1]),h=[],c=[],l=[],u=0,d=0,p=0,g=t(r),m=g.length;m>p;p++){s=g[p];var y=n.indexOf(s);if(h.push(y),-1!=y){for(var v=h.length-2;v>=0;)if(-1==h[v])v--;else{if(y>h[v])break;v=c[v]}c.push(v);var _=-1==v?0:l[v]+1;_>u&&(u=_,d=p),l.push(_)}else e.removeChild(s),c.push(-1),l.push(-1)}for(var b=[],x=h.length-1;x>=0;)-1==h[x]||x==d&&(b[h[x]]=!0,d=c[d]),x-=1;for(var C=0,g=t(n),m=g.length;m>C;C++)if(!b[C]){var A=n[C-1];i(e,g[C],A&&A._dom||o)}return a&&a._dom||o}function s(t,e,n,r){var i=e.length,s=i,f=e[i-1];if(i==n.length&&e[0]===n[0])for(;s--&&e[s]===n[s];);return-1==s?f&&f._dom||r:o(t,e,n,r)}function f(n,r,o,a,h,c){if(r===o)return r&&r._dom||r||a;if(r instanceof Array&&o instanceof Array){if(!r["static"])return s(n,r,o,a);if(r["static"]==o["static"]){for(var l=0,u=t(r),d=u.length;d>l;l++)a=f(n,u[l],o[l],a,r,l);return a}}else if("string"==typeof r||r instanceof String){var p;return o instanceof Text?(o.textContent!=r&&(o.textContent=r),p=o):(o&&e(n,o,a),p=Imba.document().createTextNode(r),i(n,p,a)),h[c]=a=p}return o&&e(n,o,a),r&&(a=i(n,r,a)),a}return Imba.extendTag("htmlelement",function(e){e.prototype.setChildren=function(t){return t===this._children?this:(t&&t["static"]?this.setStaticChildren(t):t instanceof Array&&this._children instanceof Array?s(this,t,this._children,null):"string"==typeof t||t instanceof String?this.setText(t):this.empty().append(t),this._children=t,this)},e.prototype.setStaticChildren=function(e){var n,r,i=this._children||[],o=null;if(1==e.length&&("string"==typeof e[n=0]||e[n]instanceof String))return this.setText(e[r=0]),e[r];i.length&&i["static"]||(i=[],this.empty());for(var s,a=0,h=t(e),c=h.length;c>a;a++)s=h[a],s===i[a]?s&&s._dom&&(o=s._dom):o=f(this,s,i[a],o,e,a);return this._children=e,this},e.prototype.content=function(){return this._content||this.children().toArray()},e.prototype.setText=function(t){return t!=this._children&&(this.dom().textContent=this._children=t),this}})}();
},{}],9:[function(require,module,exports){
!function(){"undefined"!=typeof window&&(global=window),Imba={VERSION:"0.13.2"};var n=/-./g;return Imba.toCamelCase=function(e){return e.replace(n,function(n){return n.charAt(1).toUpperCase()})}}();
