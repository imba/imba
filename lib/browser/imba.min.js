...
!function(){return"undefined"==typeof Imba?(require("./imba"),require("./core.events"),require("./dom"),require("./dom.client"),require("./dom.html"),require("./dom.legacy"),require("./dom.events"),require("./dom.static"),require("./selector")):void 0}();
...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,i,r){if(i instanceof h)n.removeChild(i);else if(i instanceof Array)for(var s=0,l=t(i),o=l.length;o>s;s++)e(n,l[s],r);else{var f=r?r.nextSibling:n._dom.firstChild;if(!(f instanceof Text&&f.textContent==i))throw"cannot remove string";n.removeChild(f)}return r}function n(e,i){if(i instanceof h)e.appendChild(i);else if(i instanceof Array)for(var r=0,s=t(i),l=s.length;l>r;r++)n(e,s[r]);else null!=i&&i!==!1&&e.appendChild(Imba.document().createTextNode(i))}function i(e,n,r){if(n instanceof h)e.insertBefore(n,r);else if(n instanceof Array)for(var s=0,l=t(n),o=l.length;o>s;s++)i(e,l[s],r);else null!=n&&n!==!1&&e.insertBefore(Imba.document().createTextNode(n),r);return r}function r(t,e,r){var s=r?r.nextSibling:t._dom.firstChild;return s?(i(t,e,s),s.previousSibling):(n(t,e),t._dom.lastChild)}function s(e,n,i,s){for(var l,o=n.length,h=(i.length,n[o-1]),f=[],a=[],c=[],u=0,d=0,m=0,p=t(i),v=p.length;v>m;m++){l=p[m];var g=n.indexOf(l);if(f.push(g),-1!=g){for(var _=f.length-2;_>=0;)if(-1==f[_])_--;else{if(g>f[_])break;_=a[_]}a.push(_);var y=-1==_?0:c[_]+1;y>u&&(u=y,d=m),c.push(y)}else e.removeChild(l),a.push(-1),c.push(-1)}for(var C=[],x=f.length-1;x>=0;)-1==f[x]||x==d&&(C[f[x]]=!0,d=a[d]),x-=1;for(var A=0,p=t(n),v=p.length;v>A;A++)if(!C[A]){var b=n[A-1];r(e,p[A],b&&b._dom||s)}return h&&h._dom||s}function l(t,e,n,i){var r=e.length,l=r,o=e[r-1];if(r==n.length&&e[0]===n[0])for(;l--&&e[l]===n[l];);return-1==l?o&&o._dom||i:s(t,e,n,i)}function o(n,i,s,f,a,c){var u=null==i||i===!1,d=null==s||s===!1;if(i===s)return u?f:i&&i._dom?i._dom:f?f.nextSibling:n._dom.firstChild;if(i instanceof Array){if(s instanceof Array){if(!i["static"])return l(n,i,s,f);if(i["static"]==s["static"]){for(var m=0,p=t(i),v=p.length;v>m;m++)f=o(n,p[m],s[m],f,i,m);return f}e(n,s,f)}else s instanceof h?n.removeChild(s):d||n.removeChild(f?f.nextSibling:n._dom.firstChild);return r(n,i,f)}if(i instanceof h)return null!=s&&s!==!1&&e(n,s,f),r(n,i,f),i;if(u)return d||e(n,s,f),f;var g;if(s instanceof Array)e(n,s,f);else if(s instanceof h)n.removeChild(s);else if(!d&&(g=f?f.nextSibling:n._dom.firstChild,g instanceof Text&&g.textContent!=i))return g.textContent=i,g;return r(n,i,f)}var h=Imba.TAGS.element;return Imba.extendTag("htmlelement",function(e){e.prototype.setChildren=function(t,e){if(t===this._children)return this;if("string"==typeof t)this.setText(t);else if(this._children){if(1==e)return this.setStaticChildren(t);if(2==e)return this;if(3==e)if(t instanceof Array)t["static"]?o(this,t,this._children,null,null,0):l(this,t,this._children,null);else{if(!(t instanceof h))return this.setText(t),this;this.empty(),this.appendChild(t)}else t instanceof Array&&this._children instanceof Array?l(this,t,this._children,null):this.empty().append(t)}else this.empty(),n(this,t);return this._children=t,this},e.prototype.setStaticChildren=function(e){var n,i=this._children;if(1==e.length&&("string"==typeof e[n=0]||e[n]instanceof String))return this.setText(e[0]),this;if(e["static"])o(this,e,i,null,null,0);else for(var r=null,s=0,l=t(e),h=l.length;h>s;s++)r=o(this,l[s],i[s],r,e,s);return this._children=e,this},e.prototype.content=function(){return this._content||this.children().toArray()},e.prototype.setText=function(t){return t!=this._children?(this._children=t,this):this}})}();
},{}],9:[function(require,module,exports){
!function(){"undefined"!=typeof window&&(global=window),Imba={VERSION:"0.13.5"};var n=/-./g;return Imba.toCamelCase=function(e){return e.replace(n,function(n){return n.charAt(1).toUpperCase()})}}();
