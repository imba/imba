...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,r,i){if(r instanceof Array)for(var o=0,s=t(r),f=s.length;f>o;o++)e(n,s[o],i);else if("number"==typeof r||r instanceof Number);else if("string"==typeof r){var a=i?i.nextSibling:n._dom.firstChild;if(!(a instanceof Text))throw"cannot remove string";n.removeChild(a)}else r&&n.removeChild(r);return i}function n(e,r){if(r instanceof Array)for(var i=0,o=t(r),s=o.length;s>i;i++)n(e,o[i]);else"number"==typeof r||r instanceof Number||("string"==typeof r||r instanceof String?e.appendChild(Imba.document().createTextNode(r)):r&&e.appendChild(r))}function r(e,n,i){if(("string"==typeof n||n instanceof String)&&(n=Imba.document().createTextNode(n)),n instanceof Array)for(var o=0,s=t(n),f=s.length;f>o;o++)r(e,s[o],i);else"number"==typeof n||n instanceof Number||n&&e.insertBefore(n,i);return i}function i(t,e,i){var o=i?i.nextSibling:t._dom.firstChild;return o?(r(t,e,o),o.previousSibling):(n(t,e),t._dom.lastChild)}function o(e,n,r,o){for(var s,f=n.length,a=(r.length,n[f-1]),h=[],l=[],c=[],u=0,d=0,g=0,p=t(r),m=p.length;m>g;g++){s=p[g];var y=n.indexOf(s);if(h.push(y),-1!=y){for(var v=h.length-2;v>=0;)if(-1==h[v])v--;else{if(y>h[v])break;v=l[v]}l.push(v);var x=-1==v?0:c[v]+1;x>u&&(u=x,d=g),c.push(x)}else e.removeChild(s),l.push(-1),c.push(-1)}for(var _=[],b=h.length-1;b>=0;)-1==h[b]||b==d&&(_[h[b]]=!0,d=l[d]),b-=1;for(var C=0,p=t(n),m=p.length;m>C;C++)if(!_[C]){var S=n[C-1];i(e,p[C],S&&S._dom||o)}return a&&a._dom||o}function s(t,e,n,r){var i=e.length,s=i,f=e[i-1];if(i==n.length&&e[0]===n[0])for(;s--&&e[s]===n[s];);return-1==s?f&&f._dom||r:o(t,e,n,r)}function f(n,r,o,a,h,l){if(r===o){if(null==r||r===!1||r===!0)return a;var c=a?a.nextSibling:n._dom.firstChild;return c}if(r instanceof Array&&o instanceof Array){if(!r["static"])return s(n,r,o,a);if(r["static"]==o["static"]){for(var u=0,d=t(r),g=d.length;g>u;u++)a=f(n,d[u],o[u],a,r,u);return a}}else if("string"==typeof r||r instanceof String){var p;if("string"==typeof o){var m=a?a.nextSibling:n._dom.firstChild;m instanceof Text&&(o=m)}return o instanceof Text?(o.textContent!=r&&(o.textContent=r),p=o):(o&&e(n,o,a),p=Imba.document().createTextNode(r),i(n,p,a)),a=p}return o&&e(n,o,a),r&&(a=i(n,r,a)),a}return Imba.extendTag("htmlelement",function(t){t.prototype.setChildren=function(t){return t===this._children?this:t&&t["static"]?this.setStaticChildren(t):(t instanceof Array&&this._children instanceof Array?s(this,t,this._children,null):"string"==typeof t||t instanceof String?this.setText(t):this.empty().append(t),this._children=t,this)},t.prototype.setStaticChildren=function(t){var e,n,r=this._children||[],i=null;if(1==t.length&&("string"==typeof t[e=0]||t[e]instanceof String))return this.setText(t[n=0]),t[n];r.length&&r["static"]||(r=[],this.empty());return f(this,t,r,i,null,0),this._children=t,this},t.prototype.content=function(){return this._content||this.children().toArray()},t.prototype.setText=function(t){return t!=this._children&&(this.dom().textContent=this._children=t),this}})}();
