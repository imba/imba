...
!function(){function t(t){return t?t.toArray?t.toArray():t:[]}function e(n,i,r){if(i instanceof Array)for(var o=0,s=t(i),f=s.length;f>o;o++)e(n,s[o],r);else if("number"==typeof i||i instanceof Number);else if("string"==typeof i){var a=r?r.nextSibling:n._dom.firstChild;if(!(a instanceof Text))throw"cannot remove string";n.removeChild(a)}else i&&n.removeChild(i);return r}function n(e,i){if(i instanceof Array)for(var r=0,o=t(i),s=o.length;s>r;r++)n(e,o[r]);else"number"==typeof i||i instanceof Number||("string"==typeof i||i instanceof String?e.appendChild(Imba.document().createTextNode(i)):i&&e.appendChild(i))}function i(e,n,r){if(("string"==typeof n||n instanceof String)&&(n=Imba.document().createTextNode(n)),n instanceof Array)for(var o=0,s=t(n),f=s.length;f>o;o++)i(e,s[o],r);else"number"==typeof n||n instanceof Number||n&&e.insertBefore(n,r);return r}function r(t,e,r){var o=r?r.nextSibling:t._dom.firstChild;return o?(i(t,e,o),o.previousSibling):(n(t,e),t._dom.lastChild)}function o(e,n,i,o){for(var s,f=n.length,a=(i.length,n[f-1]),h=[],l=[],c=[],u=0,d=0,g=0,m=t(i),p=m.length;p>g;g++){s=m[g];var y=n.indexOf(s);if(h.push(y),-1!=y){for(var v=h.length-2;v>=0;)if(-1==h[v])v--;else{if(y>h[v])break;v=l[v]}l.push(v);var _=-1==v?0:c[v]+1;_>u&&(u=_,d=g),c.push(_)}else e.removeChild(s),l.push(-1),c.push(-1)}for(var x=[],b=h.length-1;b>=0;)-1==h[b]||b==d&&(x[h[b]]=!0,d=l[d]),b-=1;for(var C=0,m=t(n),p=m.length;p>C;C++)if(!x[C]){var S=n[C-1];r(e,m[C],S&&S._dom||o)}return a&&a._dom||o}function s(t,e,n,i){var r=e.length,s=r,f=e[r-1];if(r==n.length&&e[0]===n[0])for(;s--&&e[s]===n[s];);return-1==s?f&&f._dom||i:o(t,e,n,i)}function f(n,i,o,a,h,l){if(i===o)return null==i||i===!1||i===!0?a:i&&i._dom?i._dom:a?a.nextSibling:n._dom.firstChild;if(i instanceof Array&&o instanceof Array){if(!i["static"])return s(n,i,o,a);if(i["static"]==o["static"]){for(var c=0,u=t(i),d=u.length;d>c;c++)a=f(n,u[c],o[c],a,i,c);return a}}else if("string"==typeof i||i instanceof String){var g;if("string"==typeof o){var m=a?a.nextSibling:n._dom.firstChild;m instanceof Text&&(o=m)}return o instanceof Text?(o.textContent!=i&&(o.textContent=i),g=o):(o&&e(n,o,a),g=Imba.document().createTextNode(i),r(n,g,a)),a=g}return o&&e(n,o,a),i&&(a=r(n,i,a)),a}return Imba.extendTag("htmlelement",function(t){t.prototype.setChildren=function(t){return t===this._children?this:t&&t["static"]?this.setStaticChildren(t):(t instanceof Array&&this._children instanceof Array?s(this,t,this._children,null):"string"==typeof t||t instanceof String?this.setText(t):this.empty().append(t),this._children=t,this)},t.prototype.setStaticChildren=function(t){var e,i,r=this._children,o=null;return 1==t.length&&("string"==typeof t[e=0]||t[e]instanceof String)?(this.setText(t[i=0]),t[i]):(r?f(this,t,r,o,null,0):(this.empty(),n(this,t)),this._children=t,this)},t.prototype.content=function(){return this._content||this.children().toArray()},t.prototype.setText=function(t){return t!=this._children&&(this.dom().textContent=this._children=t),this}})}();
