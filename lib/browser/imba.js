...
(function(){
	...
	Imba.EventManager.prototype.onenable = function (){
		...
		for (var j=0, ary=iter$(this.listeners()), len=ary.length, item; j < len; j++) {
			item = ary[j];this.root().addEventListener(item[0],item[1],item[2]);
		};
		return this;
	};
	...
	Imba.EventManager.prototype.ondisable = function (){
		...
		for (var j=0, ary=iter$(this.listeners()), len=ary.length, item; j < len; j++) {
			item = ary[j];this.root().removeEventListener(item[0],item[1],item[2]);
		};
		return this;
	};
...
(function(){
	...
	Imba.defineTag = function (name,supr,body){
		...
		if (body) { body.call(klass,klass.prototype) };
		return klass;
	};
	...
	Imba.defineTag('fragment','htmlelement', function(){
	...
	Imba.defineTag('a', function(){
		
		this.prototype.__href = {dom: true,name: 'href'};
		this.prototype.href = function(v){ return this.getAttribute('href'); }
		this.prototype.setHref = function(v){ this.setAttribute('href',v); return this; };
	});
	...
	Imba.defineTag('body');
	Imba.defineTag('br');
	Imba.defineTag('button', function(){
		
		this.prototype.__type = {dom: true,name: 'type'};
		this.prototype.type = function(v){ return this.getAttribute('type'); }
		this.prototype.setType = function(v){ this.setAttribute('type',v); return this; };
		
		this.prototype.__disabled = {dom: true,name: 'disabled'};
		this.prototype.disabled = function(v){ return this.getAttribute('disabled'); }
		this.prototype.setDisabled = function(v){ this.setAttribute('disabled',v); return this; };
	});
	...
	Imba.defineTag('form', function(){
		
		this.prototype.__method = {dom: true,name: 'method'};
		this.prototype.method = function(v){ return this.getAttribute('method'); }
		this.prototype.setMethod = function(v){ this.setAttribute('method',v); return this; };
		
		this.prototype.__action = {dom: true,name: 'action'};
		this.prototype.action = function(v){ return this.getAttribute('action'); }
		this.prototype.setAction = function(v){ this.setAttribute('action',v); return this; };
	});
	...
	Imba.defineTag('img', function(){
		
		this.prototype.__src = {dom: true,name: 'src'};
		this.prototype.src = function(v){ return this.getAttribute('src'); }
		this.prototype.setSrc = function(v){ this.setAttribute('src',v); return this; };
	});
	
	Imba.defineTag('input', function(){
		// can use attr instead
		
		this.prototype.__name = {dom: true,name: 'name'};
		this.prototype.name = function(v){ return this.getAttribute('name'); }
		this.prototype.setName = function(v){ this.setAttribute('name',v); return this; };
		
		this.prototype.__type = {dom: true,name: 'type'};
		this.prototype.type = function(v){ return this.getAttribute('type'); }
		this.prototype.setType = function(v){ this.setAttribute('type',v); return this; };
		
		this.prototype.__value = {dom: true,name: 'value'};
		this.prototype.value = function(v){ return this.getAttribute('value'); }
		this.prototype.setValue = function(v){ this.setAttribute('value',v); return this; }; // dom property - NOT attribute
		
		this.prototype.__required = {dom: true,name: 'required'};
		this.prototype.required = function(v){ return this.getAttribute('required'); }
		this.prototype.setRequired = function(v){ this.setAttribute('required',v); return this; };
		
		this.prototype.__disabled = {dom: true,name: 'disabled'};
		this.prototype.disabled = function(v){ return this.getAttribute('disabled'); }
		this.prototype.setDisabled = function(v){ this.setAttribute('disabled',v); return this; };
		
		this.prototype.__placeholder = {dom: true,name: 'placeholder'};
		this.prototype.placeholder = function(v){ return this.getAttribute('placeholder'); }
		this.prototype.setPlaceholder = function(v){ this.setAttribute('placeholder',v); return this; };
		
		this.prototype.value = function (){
			return this.dom().value;
		};
		
		this.prototype.setValue = function (v){
			this.dom().value = v;
			return this;
		};
	});
	...
	Imba.defineTag('link', function(){
		
		this.prototype.__rel = {dom: true,name: 'rel'};
		this.prototype.rel = function(v){ return this.getAttribute('rel'); }
		this.prototype.setRel = function(v){ this.setAttribute('rel',v); return this; };
		...
		this.prototype.__media = {dom: true,name: 'media'};
		this.prototype.media = function(v){ return this.getAttribute('media'); }
		this.prototype.setMedia = function(v){ this.setAttribute('media',v); return this; };
	});
	...
	Imba.defineTag('meta', function(){
		
		this.prototype.__name = {dom: true,name: 'name'};
		this.prototype.name = function(v){ return this.getAttribute('name'); }
		this.prototype.setName = function(v){ this.setAttribute('name',v); return this; };
		
		this.prototype.__content = {dom: true,name: 'content'};
		this.prototype.content = function(v){ return this.getAttribute('content'); }
		this.prototype.setContent = function(v){ this.setAttribute('content',v); return this; };
		
		this.prototype.__charset = {dom: true,name: 'charset'};
		this.prototype.charset = function(v){ return this.getAttribute('charset'); }
		this.prototype.setCharset = function(v){ this.setAttribute('charset',v); return this; };
	});
	...
	Imba.defineTag('option', function(){
		
		this.prototype.__value = {dom: true,name: 'value'};
		this.prototype.value = function(v){ return this.getAttribute('value'); }
		this.prototype.setValue = function(v){ this.setAttribute('value',v); return this; };
	});
	...
	Imba.defineTag('script', function(){
	...
	Imba.defineTag('select', function(){
		
		this.prototype.__multiple = {dom: true,name: 'multiple'};
		this.prototype.multiple = function(v){ return this.getAttribute('multiple'); }
		this.prototype.setMultiple = function(v){ this.setAttribute('multiple',v); return this; };
	...
	Imba.defineTag('textarea', function(){
		...
		this.prototype.__rows = {dom: true,name: 'rows'};
		this.prototype.rows = function(v){ return this.getAttribute('rows'); }
		this.prototype.setRows = function(v){ this.setAttribute('rows',v); return this; };
		
		this.prototype.__cols = {dom: true,name: 'cols'};
		this.prototype.cols = function(v){ return this.getAttribute('cols'); }
		this.prototype.setCols = function(v){ this.setAttribute('cols',v); return this; };
...
(function(){
	...
	ImbaSelector.prototype.__query = {name: 'query'};
