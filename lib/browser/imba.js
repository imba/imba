...
},{"./tag":11}],7:[function(require,module,exports){
(function(){
...
(function(){
	...
	function reconcileNested(root,new$,old,caret,container,ci){
		...
		if (new$ === old) {
			...
			if (old != null && old !== false) { removeNested(root,old,caret) }; // what if old is an empty string?
		...
		tag.prototype.setChildren = function (nodes,typ){
			...
			if (typeof nodes == 'string') {
				...
				if (nodes instanceof Array) {
					if (nodes.static) {
						reconcileNested(this,nodes,this._children,null,null,0);
					} else {
						reconcileCollection(this,nodes,this._children,null);
					};
				} else if (nodes instanceof ImbaTag) {
					this.empty();
