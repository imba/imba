...
(function(){
	...
	return Imba.extendTag('htmlelement', function(tag){
		...
		tag.prototype.setStatics = function (nodes){
			if (!this._children) {
				this.empty();
		...
		tag.prototype.setStaticChildren = function (new$){
			...
			if (new$.length == 1 && (typeof new$[($1=0)]=='string'||new$[$1] instanceof String)) {
				...
				reconcileNested(this,new$,old,caret,null,0);
			} else {
				this.empty();
...
(function(){
	...
	ElementTag.prototype.setStatics = function (nodes){
		throw "Not implemented";
	};
