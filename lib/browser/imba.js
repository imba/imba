...
(function(){
	...
	return Imba.TAGS.extendTag('htmlelement', function(tag){
...
(function(){
	...
	*/
	...
	return Imba.TAGS.extendTag('element', function(tag){
...
(function(){
	...
	*/
	...
	Imba.Tags.prototype.defineTag = function (name,supr,body){
		...
		this[name] = tagtype;
		this['$' + name] = TagSpawner(tagtype);
		if (body) { body.call(tagtype,tagtype,tagtype.prototype) };
		return tagtype;
	};
	...
	Imba.Tags.prototype.extendTag = function (name,body){
	...
	Imba.TAGS._nativeTypes = HTML_TAGS;
	...
	svg.baseType = function (name){
		return idx$(name,SVG_TAGS) >= 0 ? ('svgelement') : ('svgelement');
	};
