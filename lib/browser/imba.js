...
},{"./core.events":2,"./dom":6,"./dom.client":3,"./dom.events":4,"./dom.html":5,"./dom.legacy":7,"./dom.static":8,"./imba":9,"./scheduler":10,"./selector":11}],2:[function(require,module,exports){
(function(){
...
(function(){
	...
	ElementTag.prototype.tick = function (){
		this.render();
		return this;
	};
	...
	ElementTag.prototype.scheduler = function (){
		return this._scheduler == null ? (this._scheduler = new Imba.Scheduler(this)) : (this._scheduler);
	};
	
	ElementTag.prototype.schedule = function (o){
		if(o === undefined) o = {};
		this.scheduler().configure(o).activate();
		return this;
	};
	
	ElementTag.prototype.unschedule = function (){
