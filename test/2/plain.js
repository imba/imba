var self = {}, Imba = (this.Imba || require('imba2')), _1 = Imba.createElementFactory(/*SCOPEID*/);
// var Imba = require '../index'

var count = 10
self.render = function (){
	t$ = this.b$ || (this.b$ = _1('footer',null,null,''));
	c$ = t$.$;
	c$.b=t$;
	(c$.b.set('title',"Hello"));
	// v$=self.dynamic;
	// v$===c$.c || set('tabindex',c$.c=v$);
	c$.d || (c$.d = _1('section',c$.b,0,''));
	c$.e || (c$.e = _1('h1',c$.d,0,''));
	c$.e.render_("Screen",0);
	c$.f || (c$.f = _1('span',c$.d,1,'width'));
	c$.g || (c$.g = _1('span',c$.d,2,'height'));
	c$.h || (c$.h = _1('section',c$.b,1,''));
	c$.i || (c$.i = _1('div',c$.h,null,''));
	c$.i.render_("Hello",0);
	c$.j || (c$.j = _1('span',c$.h,1,''));
	c$.j.render_("Rendered ",0);
	c$.j.render_(count++,1);
	c$.j.render_(" times",2);
	return t$;
};
