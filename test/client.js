...
Imba.Tag.prototype.setSlot = function (nodes){
	this._slotForChild_ = nodes;
	return this;
};



Imba.Tag.prototype.child = function (){
	return this._slotForChild_;
};
...
describe('Syntax - Tags',function() {
	...
	test('slot',function() {
		...
		return self.jseq(("setSlot(" + self.child() + ")"),function() {
			return (_1(Custom)).end();
		});
	});
