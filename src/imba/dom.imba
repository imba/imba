...
if $node$
	export {Document,Node,Text,Element,SVGElement,HTMLElement,HTMLInputElement,HTMLSelectElement,HTMLButtonElement,HTMLOptionElement,HTMLTextAreaElement,Comment,DocumentFragment,ShadowRoot,Event,CustomEvent,MouseEvent,KeyboardEvent,PointerEvent,document} from './ssr'
